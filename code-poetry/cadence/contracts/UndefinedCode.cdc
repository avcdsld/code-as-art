...
access(all) contract UndefinedCode {

    access(all) event Find(codePoint: UInt32)

    access(all) resource Code {
        access(all) let point: UInt32
