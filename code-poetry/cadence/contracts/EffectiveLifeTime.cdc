access(all) contract EffectiveLifeTime {

    access(all) let timeBorn: UFix64
    access(all) var timeLived: UFix64

    access(all) event Beat(actualLifeTime: UFix64, effectiveLifeTime: UFix64)
